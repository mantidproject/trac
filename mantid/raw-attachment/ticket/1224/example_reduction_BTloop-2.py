...
DataPath("/home/dmn58364/mantidproject/repo/Test/Data/SANS2D")
# Set a user path where we look for the mask file
#UserPath("/home/m2d/workspace/mantid/Test/Data/SANS2D")
UserPath("/home/dmn58364/mantidproject/repo/Test/Data/SANS2D")
...
for j in range(4):
	...
	plt = plotSpectrum(ws_list, 0)
	plt.confirmClose(False)
	plt.close()
	
	# remove all of the workspaces
	workspaces = mtd.getWorkspaceNames()
	for w in workspaces:
		DeleteWorkspace(w)
