#ifndef MANTID_CURVEFITTING_Muon_ExpDecayOsc_H_
#define MANTID_CURVEFITTING_Muon_ExpDecayOsc_H_
...
namespace Mantid
{
  namespace CurveFitting
  {
    ...
    */
    class DLLExport Muon_ExpDecayOsc : public API::IPeakFunction
    {
    public:
      /// Destructor
      virtual ~Muon_ExpDecayOsc() {};
      ...
      std::string name()const{return "Muon_ExpDecayOsc";}
    protected:
...
#endif /*MANTID_CURVEFITTING_Muon_ExpDecayOsc_H_*/
