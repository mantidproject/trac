...
function_name = 'name=Polynomial,n=3'

# apply ln
log_natural = Logarithm('22041_trans_sample_1.5_12.5_unfitted', Natural=True)
# fit
Fit(Function=function_name,InputWorkspace=log_natural,Minimizer='Levenberg-MarquardtMD',CreateOutput='1',Output='linear_background',StartX='1.5',EndX='12.5')
...
Fit(Function=function_name,InputWorkspace=log_10,Minimizer='Levenberg-MarquardtMD',CreateOutput='1',Output='linear_background',StartX='1.5',EndX='12.5')
