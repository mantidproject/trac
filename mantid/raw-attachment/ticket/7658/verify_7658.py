...
class ExamineProfileParameters:
    ...
    def PyExec(self):
        ...
        if self.process_bkgd is True:
            ...
            nwusestr = 'name=Polynomial,n=6,A0=0.657699,A1=3.68433e-05,A2=-1.29638e-08,A3=1.16778e-12,A4=-4.71439e-17,A5=8.8499e-22,A6=-6.26573e-27'
            print "Background function (:(): %s" % (nwusestr)
            Fit(
                    Function        =   nwusestr,
        ...
        LeBailFit(
                ...
                BackgroundType          =   'Chebyshev', #'Polynomial',
