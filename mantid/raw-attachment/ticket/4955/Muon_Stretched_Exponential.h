#ifndef MANTID_CURVEFITTING_Muon_Stretched_Exponential_H_
#define MANTID_CURVEFITTING_Muon_Stretched_Exponential_H_
...
namespace Mantid
{
  namespace CurveFitting
  {
    ...
    */
    class DLLExport Muon_Stretched_Exponential : public API::IPeakFunction
    {
    public:
      /// Destructor
      virtual ~Muon_Stretched_Exponential() {};
     ...
     // virtual double s()const {return getParameter("lambda");}
      ...
      std::string name()const{return "Muon_Stretched_Exponential";}
...
#endif /*MANTID_CURVEFITTING_Muon_Stretched_Exponential_H_*/
