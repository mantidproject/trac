...
class IndirectFlatPlateAbsorption(PythonAlgorithm):
    ...
    def PyInit(self):
        ...
        self.declareProperty(name='Sample height', defaultValue='', doc = 'Sample height')
        self.declareProperty(name='Sample width', defaultValue='', doc = 'Sample width')
        self.declareProperty(name='Sample thickness', defaultValue='', doc = 'Sample thickness')
        self.declareProperty(name='Element size', defaultValue=0.1, doc = 'Element size in mm')
    ...
    def PyExec(self):
        ...
        FlatPlateAbsorption(InputWorkspace=swaveWS, OutputWorkspace=assWS,
            SampleHeight=self._height, SampleWidth=self._width, SampleThickness=self._thickness,
            ElementSize=self._element, EMode='Indirect', EFixed=efixed, NumberOfWavelengthPoints=10)
        ...
        sample_logs = {'sample_shape': 'flatplate', 'sample_filename': self._sam,
                        'sample_height': self._height, 'sample_width': self._width,
                        'sample_thickness': self._thickness, 'element_size': self._element}
    ...
    def _setup(self):
        ...
        self._height = float(self.getPropertyValue('Sample height'))
        self._width = float(self.getPropertyValue('Sample width'))
        self._thickness = float(self.getPropertyValue('Sample thickness'))
        self._element = self.getPropertyValue('Element size')
