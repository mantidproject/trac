#ifndef MANTID_CURVEFITTING_Muon_MuonFInteraction_H_
#define MANTID_CURVEFITTING_Muon_MuonFInteraction_H_
...
namespace Mantid
{
  namespace CurveFitting
  {
    ...
    */
    class DLLExport Muon_MuonFInteraction : public API::IPeakFunction
    {
    public:
      /// Destructor
      virtual ~Muon_MuonFInteraction() {};
     ...
     // virtual double s()const {return getParameter("Sigma");}
      ...
      virtual double f()const {return getParameter("omiga");}
	  virtual double Beta()const {return getParameter("Beta");}
	  virtual double phi()const {return getParameter("A");}

      virtual double centre()const {return getParameter("lambda");}
      virtual double height()const {return getParameter("A");}
      virtual double width()const {return 1/getParameter("omiga");}
      virtual void setCentre(const double c) {setParameter("lambda",c);}
      virtual void setHeight(const double h) {setParameter("A",h);}
      virtual void setWidth(const double w) {setParameter("omiga",1/w);}


      /// Here specify name of function as it will appear
      std::string name()const{return "Muon_MuonFInteraction";}
    protected:
...
#endif /*MANTID_CURVEFITTING_Muon_MuonFInteraction_H_*/
