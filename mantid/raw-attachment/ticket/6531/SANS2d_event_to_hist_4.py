...
#
#  ================================================ INPUT DATA HERE =================================     
DataPath("y:/data/cycle_12_4/")
samplefilename='SANS2d00016380'
# list of times to slice between,
slicelist=[0,2,8,20,40,500,1020]
...
for i in range(nslices):
	...
	CropWorkspace('SampleHist','SampleHistCropped',StartWorkspaceIndex=0,EndWorkspaceIndex=36863)
