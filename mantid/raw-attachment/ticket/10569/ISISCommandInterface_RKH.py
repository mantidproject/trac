...
def SetDetectorOffsets(bank, x, y, z, rot, radius, side, xtilt, ytilt ):
    # 19/11/14 RKH added more xtilt & ytilt
    """
	...
	# 11/11/14 RKH add 2 more
    detector.x_tilt = xtilt
    detector.y_tilt = ytilt

def SetCorrectionFile(bank, filename):
    # 20/11/14 RKH, create a new routine that allows change of "direct beam file" = correction file, for a given 
