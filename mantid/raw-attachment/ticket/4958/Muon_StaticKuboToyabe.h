#ifndef MANTID_CURVEFITTING_Muon_StaticKuboToyabe_H_
#define MANTID_CURVEFITTING_Muon_StaticKuboToyabe_H_
...
namespace Mantid
{
  namespace CurveFitting
  {
    ...
    */
    class DLLExport Muon_StaticKuboToyabe : public API::IPeakFunction
    {
    public:
      /// Destructor
      virtual ~Muon_StaticKuboToyabe() {};
     ...
     // virtual double s()const {return getParameter("lambda");}
      ...
      virtual double width()const {return 5;}
      ...
      std::string name()const{return "Muon_StaticKuboToyabe";}
...
#endif /*MANTID_CURVEFITTING_Muon_StaticKuboToyabe_H_*/
